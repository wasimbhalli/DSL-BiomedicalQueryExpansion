...
import pk.edu.kics.dsl.qa.evaluation.utils.CalculatedMeasures;
import pk.edu.kics.dsl.qa.evaluation.utils.ExactAnswer;
import pk.edu.kics.dsl.qa.evaluation.utils.Question;
import pk.edu.kics.dsl.qa.evaluation.utils.Snippet;
   ...
   public String  getQuestionID()
   {
    ...
    public void calculateAveragePrecision(ArrayList listGolden, ArrayList listResponses, CalculatedMeasures cm)
    {
	 ...
	 // we should divide with the size of the golden list
        ...
        //    check the guidlines **
         if(VERSION_OF_CHALLENGE==EvaluatorMainClass.BIOASQ2)
            cm.setAverage_precision(ap/(double)listGolden.size());
         else if(VERSION_OF_CHALLENGE==EvaluatorMainClass.BIOASQ3)
